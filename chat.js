var socket = io();
// initializes a new user and shows on he sceen when a user joins the chat application
...
// function for sending image bt uts not working.
function image (from, base64Image) {
    $('#messages').append('<li><b style="color:' + color + '">' + from + '</b>: ' + '<img src="' + base64Image + '"/>' + '</li>');
}
// funcion for generating random ID
function generateID() {
  var nameID = "";
...
$('#m').val('').focus();
 ...
 // function for showing 'typing...' functionality.
function showTyping() {
  var user = $('#user').val();
...
// shows that a user has left the discussion.
